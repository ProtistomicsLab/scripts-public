...
> [!NOTE]
> This is the space for scripts that we want to be accessible for publication purposes. Scripts for internal use are [here](https://github.com/ProtistomicsLab/scripts).
